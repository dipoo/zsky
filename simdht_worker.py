...
def get_category(ext):
    ext = ext + '.'
    cats = {
        u'1': '.avi.mp4.rmvb.m2ts.wmv.mkv.flv.qmv.rm.mov.vob.asf.3gp.mpg.mpeg.m4v.f4v.',
        u'2': '.jpg.bmp.jpeg.png.gif.tiff.',
        u'3': '.pdf.isz.chm.txt.epub.bc!.doc.ppt.',
        u'4': '.mp3.ape.wav.dts.mdf.flac.',
        u'5': '.zip.rar.7z.tar.gz.iso.dmg.pkg.',
        u'6': '.exe.app.msi.apk.'
    }
